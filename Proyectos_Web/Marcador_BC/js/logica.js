...
function espejo(){
    valiE.classList.toggle("animado")
    if(valiE.innerText == "NO"){
        valiE.classList.add("animado")
        valiE.innerText = "PRINCIPAL";
        eS = 1;
    }else{
        if(valiE.innerText == "PRINCIPAL"){
        valiE.classList.add("animado")
        valiE.innerText = "TODOS";
        eS = 2;
        }else{
        valiE.classList.add("animado")
        valiE.innerText = "NO";
...
function gC() {
    ...
    // Crear una solicitud XMLHttpRequest para enviar los datos al servidor PHP
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "php/saveC.php", true);
    ...
    var data = "contadorA=" + conA.innerText +
               "&contadorB=" + conB.innerText +
               "&setA=" + conAS.innerText +
               "&setB=" + conBS.innerText +
               "&cPuntos=" + pT +
               "&cSets=" + sT +
               "&tiempoA=" + tA.innerText +
               "&tiempoB=" + tB.innerText +
               "&espejo=" + eS;

    // Enviar los datos
    xhr.send(data);
}
//D583FEFE3B76D68CE6982E95DC7EDB32A45A3B5B6444A3BA97D324D3FE76EFE26754DBD76C3796F9386EC6F6549B5733C72433FC55A88A94DA75E97B58A8F3A73B663E48267BEFA2FDE86CF2C5E25F2ADE68C4EC7C69B34E